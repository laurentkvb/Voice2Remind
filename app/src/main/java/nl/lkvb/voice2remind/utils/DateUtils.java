...
public class DateUtils {
    ...
    /**
     * Date formatted as day, month(written) and year
     *
     * @param mCalendar
     * @return
     */
    public static String getDateFormatted(Calendar mCalendar, boolean withYear) {
        if (withYear) {
            return new SimpleDateFormat("d MMMM yyyy").format(mCalendar.getTime());

        } else {
            return new SimpleDateFormat("d MMMM").format(mCalendar.getTime());
        }
    }
    ...
    public static String getDateFormatted(Calendar calendar) {
        return new SimpleDateFormat("d MMMM yyyy HH:mm").format(calendar.getTime());
    }
    /**
     ...
     * @return
     */
    public static String getHourMinuteFormatted(Calendar calendar) {
        return new SimpleDateFormat("HH:mm").format(calendar.getTime());
    }
    /**
     * Date formatted as day,month
     *
     * @param calendar
     * @return
     */
    public static String getDayMonthFormatted(Calendar calendar){
